package com.Benhanan14406.dragon.worldgen;
...
public class ModBiomeModifiers {
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(BensBeastiary.MODID, name));
    }
...
//
    public static final ResourceKey<BiomeModifier> BASILISK_SPAWNS = registerKey("basilisk_spawns");
